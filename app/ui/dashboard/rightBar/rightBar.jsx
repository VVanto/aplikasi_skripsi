                ...
                <>
                    ...
                    <div className="fixed right-0 top-0 h-full w-[350px] bg-olive backdrop-blur-sm p-5 shadow-2xl z-50 border-l border-cream/10 animate-slide-in">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <button onClick={() => setIsOpen(false)} className="text-cream hover:text-white transition">
                                <MdClose size={24} />
                            </button>
                        </div>
                        ...
                        {loading ? (
                            ...
                            <div className="space-y-3 max-h-[calc(100vh-200px)] overflow-y-auto pr-2">
                                {lowStock.map((item) => {
                                    const content = (
                                        <div
                                            className={`block p-3 bg-lightOlive/50 border border-lightOlive rounded-lg transition-all ${isAdmin ? "hover:bg-lightOlive cursor-pointer" : "cursor-default opacity-90"
                                                }`}
                                        >
